...
With random forest approach importance of variable can be found, as can be seen below. 
```{r, echo=TRUE}
varImpPlot(finalModel)
```
However as accuracy is very high without restricting to the most important set of variables, there was no need to perform such restriction. 
